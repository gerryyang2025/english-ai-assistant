...
专为英语学习者设计的综合英语学习平台，帮助轻松掌握英语单词、语句和阅读。

**使用建议：本网站已针对 Chrome 浏览器进行优化，建议使用 Chrome 浏览器以获得最佳体验。同时已支持 iPad Chrome APP 模式，提供完整的移动端体验。**

## 📖 项目介绍

本系统是一个交互式英语学习平台，通过闪卡测试、语句练习、阅读跟读、进度追踪、AI 助手等多种方式，帮助英语学习爱好者更高效地掌握英语单词、语句和阅读材料。
...
### 3. 语句练习
- **单元选择练习**：选择书本单元进行句子听写练习
- **智能分词**：句子自动分词生成输入框
- **答案检查**：实时检查填写是否正确
- **参考答案**：点击可查看完整答案
- **语音播放**：支持播放句子语音
- **结果统计**：记录练习结果（正确数、错误数、用时）
- **错句记录**：答错的句子自动加入错句本
...
- **内容展示**：显示句型、知识点、对话内容
- **语音播放**：支持逐句播放和全部播放
- **知识点**：Markdown 格式展示知识点
- **进度追踪**：标记阅读完成状态

### 5. 错题本
- **错词管理**：自动记录错误的单词，支持分页浏览和收藏
- **错句管理**：记录阅读和语句练习中出错的句子，方便针对性复习
- **复习功能**：支持复习全部错词或错句，薄弱环节重点突破
- **移除功能**：可从错题本移除已掌握的单词或句子
...
- **友好的界面**：色彩柔和，适合各年龄段学习者
- **大字体显示**：单词、语句和阅读内容采用大字体，方便阅读
- **动画效果**：闪卡翻转动画增加学习趣味性
- **响应式设计**：支持电脑、平板和手机等多种设备，包括 iPad Chrome APP 模式
- **操作简单**：按钮大且清晰，易于点击操作
- **AI 助手**：绿色/青色渐变主题，突出显示
- **每日笑话**：首页显示趣味英文笑话，增加学习乐趣
- **服务健康检测**：智能检测服务状态，友好提示不可用情况
- **综合学习**：单词、语句、阅读三大模块全覆盖
- **工具页面**：支持 Markdown/JSON 转换、实时生效、格式检查
- **数据安全**：上传文件安全检查，防止恶意文件
- **iPad 优化**：完整的 iPad Chrome APP 模式支持，包括安全区域适配、动态视口高度、滚动优化
...
- **生产部署**：Gunicorn 支持高并发
- **服务健康检查**：前后端协同的健康检测机制
- **响应式设计**：完整的移动端适配（5个断点，含 iPad 专用）
- **iPad 优化**：动态视口高度（dvh/svh）、安全区域适配、滚动区域优化
- **综合学习模块**：单词记忆、语句练习、阅读跟读三位一体
- **工具页面**：在线数据转换、实时生效、格式验证
- **安全检查**：文件类型验证、内容安全扫描

## 📝 更新日志

更新日志可见 [CHANGELOG.md](./CHANGELOG.md)
