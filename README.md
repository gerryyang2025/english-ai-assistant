...
本系统是一个交互式英语学习网站，通过闪卡测试、进度追踪、AI 助手等多种方式，帮助英语学习爱好者更高效地记忆英语单词。
...
- **错题本**：自动记录错误次数多的单词，方便重点复习（支持错词和错句分开管理）
...
| v3.1 | 2026-01-25 | 新增语句练习功能：选择书本单元进行句子听写练习；新增错句复习功能：复习错句本中的句子 |
| v3.2 | 2026-01-25 | 完善 iPad Chrome APP 模式支持：动态视口高度、安全区域适配、滚动优化、底部控制栏防遮挡；优化语句练习答案显示格式；修复 Web Speech API 错误提示 |
