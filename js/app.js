...
/** 可切换的墨小灵 Lottie：无 URL、无 localStorage 时每次加载随机；`?mascot=` / `localStorage.moxiaolingLottieVariant` 可固定形象（可选）。键含 `mascot-basketball`、`mascot-rabbit` 等，见 `MOXIAOLING_LOTTIE_BY_KEY` */
const MOXIAOLING_LOTTIE_BY_KEY = {
    ...
    'mascot-death-dance': 'lottie/mascot-death-dance.json',
    'mascot-alien-poke-emoji': 'lottie/mascot-alien-poke-emoji.json',
